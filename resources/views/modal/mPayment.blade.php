                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between row ">
                        ...
                        <div class="mb-3 col-6 border">
                            ...
                            <input type="text" name="days" class="form-control" value="{{ $local->dias }}" id="days" aria-describedby="daysHelp" readonly hidden>
                            <input type="text"  class="form-control" value="{{ trim($local->dias, ',') }}"   readonly>
                        ...
                        <div class="mb-3 col-3 border">
                            ...
                            <input type="text" name="cost" class="form-control" id="cost" value="10" aria-describedby="costHelp" disabled>
                        ...
                        <div class="mb-3 col-3 border">
                            ...
                            $<input type="text" name="value" class="form-control" id="value" value="0" aria-describedby="valueHelp" readonly>
